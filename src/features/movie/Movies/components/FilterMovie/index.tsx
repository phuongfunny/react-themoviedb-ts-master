...
import { listCertif, genres, sortOption } from '../../../../../constant/movie/index';
import RangeSlider from '../../../../../custom-fields/custom-slider/RangeSlider';
import './style.scss';
          ...
          <Card>
            <CardBody>
              ...
              <div className="select sort-option">
                <Input type="select" name="select" id="exampleSelect" className="list-option">
            ...
            <CardBody>
              <div className="filter">
                ...
                <div className="option-filter">
                  <FormGroup className="option">
                    <FormGroup>
                      <Label>
                        <Input type="radio" name="radio1" defaultChecked /> Everything
                      </Label>
                    </FormGroup>
                    <FormGroup>
                      <Label>
                        <Input type="radio" name="radio1" defaultChecked /> Movies I Haven't Seen
                      </Label>
                    </FormGroup>
                    <FormGroup>
                      <Label>
                        <Input type="radio" name="radio1" defaultChecked /> Movies I Have Seen
                      </Label>
                    </FormGroup>
                  </FormGroup>
                </div>
              ...
              <div className="filter">
                ...
                <div className="all_avail option-filter">
                  <FormGroup>
                    <Label>
                      <Input type="checkbox" defaultChecked /> Search all availabilities?
                    </Label>
                  </FormGroup>
                </div>
              </div>
              <div className="filter">
                ...
                <div className="all_avail option-filter">
                  <FormGroup>
                    <Label>
                      <Input type="checkbox" defaultChecked /> Search all releases?
                    </Label>
                  </FormGroup>
